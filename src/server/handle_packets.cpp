...
void player_joined(World &world, ClientMessage msg, NetworkServer &server)
{
    ...
    id = world.create_player("", Vector4i(375, 6, 21, 24), Vector2f(DEFAULT_PLAYER_SCALE, DEFAULT_PLAYER_SCALE),
        Vector2i(DEFAULT_PLAYER_POS_X, DEFAULT_PLAYER_POS_Y), DEFAULT_PLAYER_HP, Vector2i(0, 0), 0.2, DEFAULT_KEY_TOP, DEFAULT_KEY_BOT,
...
void create_enemy(World &world, NetworkServer &server)
{
    ...
    world.create_enemy("r-typesheet39.gif", Vector4i(34, 2, 64, 64), Vector2f(DEFAULT_ENEMY_SCALE, DEFAULT_ENEMY_SCALE), Vector2i(0,
        random_y), Vector2i(DEFAULT_ENEMY_SPD, DEFAULT_ENEMY_SPD), 0.2, 0);
