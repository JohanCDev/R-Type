...
void MenuScene::init_menu(sf::RenderWindow &window)
{
    ...
    _world.create_button(
        "assets/background/bg-boutton.png", Vector4i{41, 28, 657, 284}, Vector2f{0.4, 0.4}, pos, &go_to_lobby);
    ...
    _world.create_button(
        "assets/background/bg-boutton.png", Vector4i{41, 28, 657, 284}, Vector2f{0.4, 0.4}, pos, &go_to_option);
    ...
    _world.create_button(
        "assets/background/bg-boutton.png", Vector4i{41, 28, 657, 284}, Vector2f{0.4, 0.4}, pos, &quit_callback);
